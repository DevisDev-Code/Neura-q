...
export const SynthesisReport: React.FC<Props> = ({ synthesis, isProcessing }) => {
    return (
        <div className="min-h-screen bg-[#050508] p-4 md:p-12 flex justify-center pb-24">
                ...
                {isProcessing ? (
                    <div className="flex flex-col items-center justify-center h-96 space-y-8">
                        <div className="relative w-24 h-24">
                            ...
                            <div className="absolute inset-4 border-t-4 border-[#c9a84c] rounded-full animate-spin" style={{ animationDirection: 'reverse' }}></div>
                        </div>
                    ...
                    <div className="prose prose-lg max-w-none prose-headings:font-serif prose-headings:font-bold prose-headings:text-black prose-h1:text-3xl prose-h1:uppercase prose-h1:tracking-tight prose-h1:border-b prose-h1:pb-2 prose-h2:text-xl prose-h2:mt-12 prose-h2:mb-6 prose-h2:text-blue-900 prose-p:font-sans prose-p:leading-relaxed prose-p:text-gray-800 prose-li:font-sans prose-table:border-collapse prose-table:text-sm prose-table:w-full prose-table:my-8 prose-th:bg-gray-100 prose-th:p-4 prose-th:text-left prose-th:font-mono prose-th:uppercase prose-th:text-xs prose-th:tracking-wider prose-td:border-b prose-td:border-gray-200 prose-td:p-4 prose-td:align-top prose-strong:font-bold prose-strong:text-black">
                        {synthesis ? (
